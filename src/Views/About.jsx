    ...
    return (
        <>
            ...
            <div className='h-full w-full bg-black'>
                ...
                <h1 className='text-white xs:text-sm md:text-lg md:mt-10 text-center'>Here you will find more information about me, <br className='xs:hidden md:block' /> what I do, and my current skills mostly in terms of programming and technology.</h1>
                <div className='text-white md:flex items-center justify-around h-screen container mx-auto xs:mt-2'>
                    <div className='md:w-1/2 flex-col items-center'>
                        ...
                        <h1 className='lg:text-3xl md:text-xl xs:mt-10 md:-mt-20  flex items-center justify-center' style={{ fontFamily: 'Josefin Sans' }} >Education <span className='text-orange-500 ml-2'>Details</span><FaGripfire /></h1>
                    ...
                    <div className='md:w-1/2 xs:mt-5 '>
                        <h1 className='md:text-xl lg:text-3xl md:-mt-20 text-center flex items-center justify-center' style={{ fontFamily: 'Josefin Sans' }}>My Skill<span className='text-orange-500'>s</span><FaGripfire /></h1>
                        {/* <hr className='md:hidden' /> */}
                        <div className=''>

            ...
            <div className='h-full w-full bg-black'>
                ...
                <div className='text-white md:flex items-center justify-around h-screen container mx-auto xs:mt-2'>
                    <div className=' items-center xs:mt-20'>
                        ...
                        >
                            <Tab eventKey="contact" title="Home" className='md:text-xs md:w-60 text-red-900 lg:w-96'>
                                <h1 style={{ fontFamily: 'Josefin Sans' }} className='text-white xs:text-sm md:text-sm mt-5 lg:text-lg md:mt-10 text-center'>Here you will find more information about me, <br className='xs:hidden md:block' /> what I do, and my current skills mostly in terms of programming and technology.</h1>
                    ...
                    <div className='xs:mt-20 md:-mt-20 lg:-mt-20 text-center'>
                        ...
                        <div className=''>
                            <h1 className='mt-3 flex justify-center items-center' style={{ fontFamily: 'Josefin Sans' }}><IoLogoJavascript fontSize={20} className='mr-2 text-yellow-400' />JavaScript</h1>
                            <h1 className='mt-2 flex justify-center items-center' style={{ fontFamily: 'Josefin Sans' }}><FaReact fontSize={20} className='mr-2 text-cyan-400' />React Js</h1>
                            <h1 className='mt-2 flex justify-center items-center' style={{ fontFamily: 'Josefin Sans' }}><SiExpress fontSize={20} className='mr-2' />Express Js</h1>
                            <h1 className='mt-2 flex justify-center items-center' style={{ fontFamily: 'Josefin Sans' }}><FaNodeJs fontSize={20} className='mr-2 text-lime-700' />Node Js</h1>
                            <h1 className='mt-2 flex justify-center items-center' style={{ fontFamily: 'Josefin Sans' }}><SiMongodb fontSize={20} className='mr-2 text-green-500' />Mongo DB</h1>
                            <h1 className='mt-2 flex justify-center items-center' style={{ fontFamily: 'Josefin Sans' }}><FaLaravel fontSize={20} className='mr-2 text-red-500' />Laravel</h1>
                        </div>

                        <Link to='/Projects' className='w-28 mt-4 mx-auto bg-orange-500 rounded-full p-2 flex items-center justify-center hover:text-black hover:bg-white text-sm' style={{ fontFamily: 'Josefin Sans' }}>Projects<BsArrowRightCircle className='ml-2 text-lg' /></Link>
                    </div>
